...
function renderInsights(m) {
  ...
  return `<section class="insight-banner"><div><span class="eyebrow">ПОСЛЕ ВСТРЕЧИ НАЧИНАЕТСЯ ГЛАВНОЕ</span><h2>От решений к результату</h2><p>Найдите незакрытые вопросы и подготовьте следующий шаг.</p></div><span class="insight-orbit" aria-hidden="true">${icon("arrow-up-right")}</span></section>
  <div class="tool-grid"><a class="tool-tile" href="/api/meetings/${m.id}/agenda"><span class="tool-glyph">${icon("agenda")}</span><strong>Следующая повестка</strong><p>Открытые поручения, ответственные и вопросы для следующей встречи.</p><span class="tool-cta">Скачать Markdown ↗</span></a><a class="tool-tile" href="/api/meetings/${m.id}/calendar"><span class="tool-glyph">${icon("meetings")}</span><strong>Поручения в календарь</strong><p>Только проверенные задачи с подтверждённой датой. Импорт в Outlook или Calendar.</p><span class="tool-cta">Скачать ICS ↗</span></a></div>
